      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
            ...
            <div className="flex items-center min-w-0 flex-shrink-0">
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-600 to-purple-700 rounded-xl overflow-hidden transform group-hover:scale-110 transition-transform duration-300 border-2 border-white/20">
                    <img 
                      src="/logo.png" 
                      alt="Smart Wallet Logo" 
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        // Fallback if logo doesn't load - use SVG instead of emoji for consistency
                        e.currentTarget.src = 'data:image/svg+xml;base64,';
                      }}
                    />
                  </div>
                </div>
                <div className="min-w-0">
                  <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-700 text-lg sm:text-xl transition-all duration-300 group-hover:tracking-wide truncate">
                    Smart Wallet
                  </span>
                  <span className="ml-1 sm:ml-2 text-xs bg-gradient-to-r from-blue-600 to-purple-700 text-white px-1.5 sm:px-2 py-0.5 rounded-full font-medium shadow-sm transform group-hover:scale-105 transition-transform duration-300">
                    Web3
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 min-w-0 flex-shrink-0">
              {isConnected ? (
                <>
                  ...
                  {/* Mobile - Simplified wallet indicator */}
                  <div className="md:hidden flex items-center space-x-2">
                    <div className="bg-green-100 rounded-full p-1">
                      <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    </div>
                    <span className="text-xs font-medium text-gray-700 hidden xs:inline">Connected</span>
                  </div>
                ...
                <button 
                  ...
                  className="relative overflow-hidden group flex items-center px-3 py-2 sm:px-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg font-medium transition-all duration-300 hover:shadow-lg active:scale-95 text-xs sm:text-sm min-h-[36px] sm:min-h-[40px] focus:ring-2 focus:ring-blue-300"
                >
                  ...
                  <span className="mr-1 sm:mr-2 text-sm sm:text-lg group-hover:animate-bounce">🔗</span>
              ...
              <div className="lg:hidden">
                <button 
                  ...
                  className="inline-flex items-center justify-center p-2 sm:p-3 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-blue-50 transition-colors duration-300 active:scale-95"
        ...
        {menuOpen && (
          <div className="lg:hidden bg-white/95 backdrop-blur-lg border-t border-gray-200/50 shadow-lg animate-fade-in">
            <div className="px-3 sm:px-4 pt-4 pb-6 space-y-4">
              {/* Mobile Navigation */}
                ...
                <div className="pt-4 border-t border-gray-200">
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 border border-blue-200/50">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button 
                        onClick={copyAddress}
                        className="font-mono text-xs text-blue-600 hover:text-blue-800 transition-colors bg-white px-2 py-1 rounded border max-w-[120px] truncate"
                      >
                        {formattedAddress} 📋
                      </button>
                    </div>
